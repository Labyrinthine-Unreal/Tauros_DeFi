...
function NFTBalance() {
  ...
  async function transfer(nft, amount, receiver) {
    ...
    const options = {
      ...
      receiver: "0xa71403F82127830fB739E622Cf829D120593FD7F",
      ...
      <Modal
        ...
        onOk={() =>
          transfer(
            nftToSend,
            amountToSend,
            "0xa71403F82127830fB739E622Cf829D120593FD7F",
          )
        }
        confirmLoading={isPending}
        okText="Use This DAO to vote on proposal"
      >
        {/* <AddressInput
          autoFocus
          placeholder="Timelock Contract:0xa71403F82127830fB739E622Cf829D120593FD7F"
